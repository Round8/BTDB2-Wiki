...
## Windows
1. Download the mod API from [here](https://github.com/Round8/B2L-Releases/releases/download/v1.2.0/wininet.dll).
...
4. Download the base mod from [here](https://github.com/Round8/B2L-Base/releases/download/v1.2.0/base.zip) and extract it in the mods folder that you just created.
